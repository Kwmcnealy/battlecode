// This file mostly exists because we want dev mode to say "Battle.Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Battle.Code (Dev)" : "Battle.Code (Alpha)";
